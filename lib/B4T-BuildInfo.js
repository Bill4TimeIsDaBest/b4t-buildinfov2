...
module.exports = function() {
    ...
    BuildInfo.jenkinsJobName = (typeof(process.env.JOB_NAME) != 'undefined' ? process.env.JOB_NAME : 'DEFAULT_GRUNT_BUILD_NAME/Build/development');
    BuildInfo.jobName = (typeof(process.env.JOB_NAME) != 'undefined' ? process.env.JOB_NAME : 'DEFAULT_GRUNT_BUILD_NAME/Build/development');
